class Dice {
    ...
    roll() {
        ...
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = 'url("one.png")';
        }
        if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = 'url("two.png")';
        }
        if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = 'url("three.png")';
        }
        if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = 'url("four.png")';
        }
        if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = 'url("five.png")';
        }
        if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = 'url("six.png")';
        }
        if (this.type == 1) {
            if (this.r.checker()) {
